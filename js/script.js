...
const bakingTime = 1000 * 60 * 60 * 6; // 6 hours
...
const slotsElements = slots.map(id => document.getElementById(id)); //pega todos os slots 
...
//#region exportable data state > traduction: estado de dados exportáveis da região
let exportableData = []
...
// Start baking button - traduction: Botão Start
...
// Stop baking button //Botão finalizar
